  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await registerUser({
        name: formData.name.trim(), email: formData.email,
      ...
      <div className="register-card">
        ...
        {errors.general && (
          <div className="register-alert" role="alert">
            <AlertIcon aria-hidden="true" />{errors.general}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="register-form">
          ...
          <div className="register-field">
            ...
            <div className="register-input-wrap">
              ...
              <input type="text" id="name" name="name" placeholder="Dishant Java"
                value={formData.name} onChange={handleChange}
                className={errors.name ? 'error' : ''} disabled={isLoading} autoFocus />
            </div>
            {errors.name && <span className="register-error-msg">{errors.name}</span>}
          </div>
