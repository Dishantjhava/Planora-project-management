...
const handleQuickCreateTask = async () => {
  ...
  const handleQuickInvite = () => {
    ...
    const invite = {
      ...
      role: inviteForm.role || 'Developer', avatar: inviteForm.name.trim().split(' ').map(w => w[0]).join('').toUpperCase().slice(0,2),
    ...
    setNotifications(prev => [{
      ...
      message: `Member ${invite.name} added (pending approval)`,
          ...
          <div className="home-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="home-modal-body">
              ...
              <div className="hform-group">
                <label>Role</label>
                <select
                  value={inviteForm.role || 'Developer'}
            ...
            <div className="home-modal-footer">
              ...
              <button className="hbtn-primary" onClick={handleQuickInvite}>Add Member</button>
            </div>
          </div>
        </div>
      )}
